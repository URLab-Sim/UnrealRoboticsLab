...
void UMjSite::ImportFromXml(const FXmlNode* Node, const FMjCompilerSettings& CompilerSettings)
{
	...
	{ // xml_enum: type -> EMjSiteType
		...
		{
			Type = EMjSiteType::Cylinder;
		}
		else if (S == TEXT("box"))
		{
			Type = EMjSiteType::Box;
		}
		else if (S == TEXT("mesh"))
		{
			Type = EMjSiteType::Mesh;
		}
		else if (S == TEXT("hfield"))
		{
			Type = EMjSiteType::Hfield;
		}
	}
...
// distinguish them.
UMjBoxSite::UMjBoxSite()
{
	Type = EMjSiteType::Box;
}
UMjSphereSite::UMjSphereSite()
{
	Type = EMjSiteType::Sphere;
}
UMjCapsuleSite::UMjCapsuleSite()
{
	Type = EMjSiteType::Capsule;
}
UMjCylinderSite::UMjCylinderSite()
{
	Type = EMjSiteType::Cylinder;
}
UMjEllipsoidSite::UMjEllipsoidSite()
{
	Type = EMjSiteType::Ellipsoid;
}

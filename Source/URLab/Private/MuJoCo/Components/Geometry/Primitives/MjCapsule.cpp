...
{
	if (IsValid(VisualizerShaft) && IsValid(VisualizerCapTop) && IsValid(VisualizerCapBottom))
		return;
	...
	if (!IsValid(VisualizerShaft))
		VisualizerShaft = MakeSubMesh(TEXT("VisualizerShaft"), CylinderMesh);
	if (!IsValid(VisualizerCapTop))
		VisualizerCapTop = MakeSubMesh(TEXT("VisualizerCapTop"), SphereMesh);
	if (!IsValid(VisualizerCapBottom))
		VisualizerCapBottom = MakeSubMesh(TEXT("VisualizerCapBottom"), SphereMesh);

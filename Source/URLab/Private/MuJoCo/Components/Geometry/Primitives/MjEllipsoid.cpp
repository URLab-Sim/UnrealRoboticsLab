...
UMjEllipsoid::UMjEllipsoid()
{
    Type = EMjGeomType::Ellipsoid;
}

void UMjEllipsoid::ImportFromXml(const FXmlNode* Node, const FMjCompilerSettings& CompilerSettings)
{
...
void UMjEllipsoid::ExportTo(mjsGeom* Element, mjsDefault* Default)
{
    if (!Element) return;

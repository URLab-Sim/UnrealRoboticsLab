...
UMjPluginSensor::UMjPluginSensor()
{
    Type = EMjSensorType::Plugin;
}

void UMjPluginSensor::ImportFromXml(const FXmlNode* Node, const FMjCompilerSettings& CompilerSettings)
{
...
void UMjPluginSensor::ExportTo(mjsSensor* Element, mjsDefault* Default)
{
    if (!Element) return;

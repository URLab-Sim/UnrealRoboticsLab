...
void UMjSensor::ExportTo(mjsSensor* Element, mjsDefault* Default)
{
	...
	switch (Type)
	{
		...
		case EMjSensorType::Touch:
			Element->type = mjSENS_TOUCH;
			Element->objtype = mjOBJ_SITE;
			break;
		case EMjSensorType::Accelerometer:
			Element->type = mjSENS_ACCELEROMETER;
			Element->objtype = mjOBJ_SITE;
			break;
		case EMjSensorType::Velocimeter:
			Element->type = mjSENS_VELOCIMETER;
			Element->objtype = mjOBJ_SITE;
			break;
		case EMjSensorType::Gyro:
			Element->type = mjSENS_GYRO;
			Element->objtype = mjOBJ_SITE;
			break;
		case EMjSensorType::Force:
			Element->type = mjSENS_FORCE;
			Element->objtype = mjOBJ_SITE;
			break;
		case EMjSensorType::Torque:
			Element->type = mjSENS_TORQUE;
			Element->objtype = mjOBJ_SITE;
			break;
		case EMjSensorType::Magnetometer:
			Element->type = mjSENS_MAGNETOMETER;
			Element->objtype = mjOBJ_SITE;
			break;
		...
		case EMjSensorType::JointPos:
			Element->type = mjSENS_JOINTPOS;
			Element->objtype = mjOBJ_JOINT;
			break;
		case EMjSensorType::JointVel:
			Element->type = mjSENS_JOINTVEL;
			Element->objtype = mjOBJ_JOINT;
			break;
		case EMjSensorType::BallQuat:
			Element->type = mjSENS_BALLQUAT;
			Element->objtype = mjOBJ_JOINT;
			break;
		case EMjSensorType::BallAngVel:
			Element->type = mjSENS_BALLANGVEL;
			Element->objtype = mjOBJ_JOINT;
			break;
		case EMjSensorType::JointLimitPos:
			Element->type = mjSENS_JOINTLIMITPOS;
			Element->objtype = mjOBJ_JOINT;
			break;
		case EMjSensorType::JointLimitVel:
			Element->type = mjSENS_JOINTLIMITVEL;
			Element->objtype = mjOBJ_JOINT;
			break;
		case EMjSensorType::JointLimitFrc:
			Element->type = mjSENS_JOINTLIMITFRC;
			Element->objtype = mjOBJ_JOINT;
			break;
		case EMjSensorType::TendonPos:
			Element->type = mjSENS_TENDONPOS;
			Element->objtype = mjOBJ_TENDON;
			break;
		case EMjSensorType::TendonVel:
			Element->type = mjSENS_TENDONVEL;
			Element->objtype = mjOBJ_TENDON;
			break;
		case EMjSensorType::TendonLimitPos:
			Element->type = mjSENS_TENDONLIMITPOS;
			Element->objtype = mjOBJ_TENDON;
			break;
		case EMjSensorType::TendonLimitVel:
			Element->type = mjSENS_TENDONLIMITVEL;
			Element->objtype = mjOBJ_TENDON;
			break;
		case EMjSensorType::TendonLimitFrc:
			Element->type = mjSENS_TENDONLIMITFRC;
			Element->objtype = mjOBJ_TENDON;
			break;
		case EMjSensorType::ActuatorPos:
			Element->type = mjSENS_ACTUATORPOS;
			Element->objtype = mjOBJ_ACTUATOR;
			break;
		case EMjSensorType::ActuatorVel:
			Element->type = mjSENS_ACTUATORVEL;
			Element->objtype = mjOBJ_ACTUATOR;
			break;
		case EMjSensorType::ActuatorFrc:
			Element->type = mjSENS_ACTUATORFRC;
			Element->objtype = mjOBJ_ACTUATOR;
			break;
		case EMjSensorType::JointActFrc:
			Element->type = mjSENS_JOINTACTFRC;
			Element->objtype = mjOBJ_JOINT;
			break;
		case EMjSensorType::TendonActFrc:
			Element->type = mjSENS_TENDONACTFRC;
			Element->objtype = mjOBJ_TENDON;
			break;
		case EMjSensorType::FramePos:
			Element->type = mjSENS_FRAMEPOS;
			break;
		case EMjSensorType::FrameQuat:
			Element->type = mjSENS_FRAMEQUAT;
			break;
		case EMjSensorType::FrameXAxis:
			Element->type = mjSENS_FRAMEXAXIS;
			break;
		case EMjSensorType::FrameYAxis:
			Element->type = mjSENS_FRAMEYAXIS;
			break;
		case EMjSensorType::FrameZAxis:
			Element->type = mjSENS_FRAMEZAXIS;
			break;
		case EMjSensorType::FrameLinVel:
			Element->type = mjSENS_FRAMELINVEL;
			break;
		case EMjSensorType::FrameAngVel:
			Element->type = mjSENS_FRAMEANGVEL;
			break;
		case EMjSensorType::FrameLinAcc:
			Element->type = mjSENS_FRAMELINACC;
			break;
		case EMjSensorType::FrameAngAcc:
			Element->type = mjSENS_FRAMEANGACC;
			break;
		case EMjSensorType::SubtreeCom:
			Element->type = mjSENS_SUBTREECOM;
			Element->objtype = mjOBJ_BODY;
			break;
		case EMjSensorType::SubtreeLinVel:
			Element->type = mjSENS_SUBTREELINVEL;
			Element->objtype = mjOBJ_BODY;
			break;
		case EMjSensorType::SubtreeAngMom:
			Element->type = mjSENS_SUBTREEANGMOM;
			Element->objtype = mjOBJ_BODY;
			break;
		case EMjSensorType::InsideSite:
			Element->type = mjSENS_INSIDESITE;
			Element->reftype = mjOBJ_SITE;
			break;
		case EMjSensorType::GeomDist:
			Element->type = mjSENS_GEOMDIST;
			break;
		case EMjSensorType::GeomNormal:
			Element->type = mjSENS_GEOMNORMAL;
			break;
		case EMjSensorType::GeomFromTo:
			Element->type = mjSENS_GEOMFROMTO;
			break;
		case EMjSensorType::Contact:
			Element->type = mjSENS_CONTACT;
			break;
		case EMjSensorType::EPotential:
			Element->type = mjSENS_E_POTENTIAL;
			Element->objtype = mjOBJ_UNKNOWN;
			break;
		case EMjSensorType::EKinetic:
			Element->type = mjSENS_E_KINETIC;
			Element->objtype = mjOBJ_UNKNOWN;
			break;
		case EMjSensorType::Clock:
			Element->type = mjSENS_CLOCK;
			Element->objtype = mjOBJ_UNKNOWN;
			break;
		case EMjSensorType::Tactile:
			Element->type = mjSENS_TACTILE;
			Element->objtype = mjOBJ_MESH;
			Element->reftype = mjOBJ_GEOM;
			break;
		case EMjSensorType::User:
			Element->type = mjSENS_USER;
			break;
		case EMjSensorType::Plugin:
			Element->type = mjSENS_PLUGIN;
			break;
		default:
			Element->type = mjSENS_ACCELEROMETER;
			Element->objtype = mjOBJ_SITE;

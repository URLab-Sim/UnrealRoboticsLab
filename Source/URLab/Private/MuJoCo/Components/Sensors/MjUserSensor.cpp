...
UMjUserSensor::UMjUserSensor()
{
	Type = EMjSensorType::User;
}

void UMjUserSensor::ImportFromXml(const FXmlNode* Node, const FMjCompilerSettings& CompilerSettings)
{
...
void UMjUserSensor::ExportTo(mjsSensor* Element, mjsDefault* Default)
{
	if (!Element)
		return;

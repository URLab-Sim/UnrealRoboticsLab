...
#include "MuJoCo/Controllers/MjKeyframeController.h"
...
{
	if (!OwnerArticulation || Keyframes.Num() == 0)
		return;
	if (ActuatorNames.Num() == 0)
		CacheActuatorNames();
...
{
	if (!OwnerArticulation || ActuatorNames.Num() == 0)
		return;
	...
	FActorComponentTickFunction* ThisTickFunction)
{
	...
	if (!bPlaying || Keyframes.Num() == 0 || !OwnerArticulation)
		return;

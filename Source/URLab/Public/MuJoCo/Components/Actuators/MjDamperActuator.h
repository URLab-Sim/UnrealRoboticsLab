...
#include "MjDamperActuator.generated.h"

/**
 * @class UMjDamperActuator
 * @brief Specific Damper Actuator component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjDamperActuator : public UMjActuator
{
    GENERATED_BODY()
public:
    UMjDamperActuator();

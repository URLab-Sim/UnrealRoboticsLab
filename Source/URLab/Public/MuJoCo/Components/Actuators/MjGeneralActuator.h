...
#include "MjGeneralActuator.generated.h"

/**
 * @class UMjGeneralActuator
 * @brief Represents a 'general' actuator in MuJoCo.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjGeneralActuator : public UMjActuator
{
    GENERATED_BODY()
public:

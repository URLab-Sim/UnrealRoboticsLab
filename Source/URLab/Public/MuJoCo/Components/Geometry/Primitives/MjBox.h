...
public:
	...
	/** @brief Half-extents along local X/Y/Z in MJ metres. Authored via
	 *  the UE Transform's Scale handle; hidden from the Details panel. */
	...
	{
		const_cast<UMjBox*>(this)->EnsureVisualizerMesh();

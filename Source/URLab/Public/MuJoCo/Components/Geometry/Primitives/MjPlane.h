...
#include "MjPlane.generated.h"

/**
 * @class UMjPlane
 * @brief Autogenerated component representing the MuJoCo 'plane' element.
 *
 * Subclass of UMjGeom. Sets Type = Plane in the constructor.
 */
UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class URLAB_API UMjPlane : public UMjGeom
{
    GENERATED_BODY()

...
#include "MjAccelerometer.generated.h"

/**
 * @class UMjAccelerometer
 * @brief Specific Accelerometer Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjAccelerometer : public UMjSensor
{
    GENERATED_BODY()
public:

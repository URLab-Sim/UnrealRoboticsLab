...
#include "MjActuatorFrcSensor.generated.h"

/**
 * @class UMjActuatorFrcSensor
 * @brief Specific ActuatorFrc Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjActuatorFrcSensor : public UMjSensor
{
    GENERATED_BODY()
public:

...
#include "MjActuatorPosSensor.generated.h"

/**
 * @class UMjActuatorPosSensor
 * @brief Specific ActuatorPos Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjActuatorPosSensor : public UMjSensor
{
    GENERATED_BODY()
public:

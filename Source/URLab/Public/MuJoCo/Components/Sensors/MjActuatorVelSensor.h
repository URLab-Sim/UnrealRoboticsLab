...
#include "MjActuatorVelSensor.generated.h"

/**
 * @class UMjActuatorVelSensor
 * @brief Specific ActuatorVel Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjActuatorVelSensor : public UMjSensor
{
    GENERATED_BODY()
public:

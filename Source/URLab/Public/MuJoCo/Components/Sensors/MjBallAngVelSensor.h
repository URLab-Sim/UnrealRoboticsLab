...
#include "MjBallAngVelSensor.generated.h"

/**
 * @class UMjBallAngVelSensor
 * @brief Specific BallAngVel Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjBallAngVelSensor : public UMjSensor
{
    GENERATED_BODY()
public:

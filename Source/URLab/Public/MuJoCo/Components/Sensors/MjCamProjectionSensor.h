...
#include "MjCamProjectionSensor.generated.h"

/**
 * @class UMjCamProjectionSensor
 * @brief Specific CamProjection Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjCamProjectionSensor : public UMjSensor
{
    GENERATED_BODY()
public:

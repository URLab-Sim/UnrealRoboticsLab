...
#include "MjEPotentialSensor.generated.h"

/**
 * @class UMjEPotentialSensor
 * @brief Specific EPotential Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjEPotentialSensor : public UMjSensor
{
    GENERATED_BODY()
public:

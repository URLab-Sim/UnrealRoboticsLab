...
#include "MjFrameAngVelSensor.generated.h"

/**
 * @class UMjFrameAngVelSensor
 * @brief Specific FrameAngVel Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjFrameAngVelSensor : public UMjSensor
{
    GENERATED_BODY()
public:

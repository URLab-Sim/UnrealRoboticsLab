...
#include "MjFrameLinAccSensor.generated.h"

/**
 * @class UMjFrameLinAccSensor
 * @brief Specific FrameLinAcc Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjFrameLinAccSensor : public UMjSensor
{
    GENERATED_BODY()
public:

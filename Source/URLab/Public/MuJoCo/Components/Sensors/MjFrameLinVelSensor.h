...
#include "MjFrameLinVelSensor.generated.h"

/**
 * @class UMjFrameLinVelSensor
 * @brief Specific FrameLinVel Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjFrameLinVelSensor : public UMjSensor
{
    GENERATED_BODY()
public:

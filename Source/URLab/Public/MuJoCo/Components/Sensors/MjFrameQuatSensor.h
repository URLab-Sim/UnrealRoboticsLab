...
#include "MjFrameQuatSensor.generated.h"

/**
 * @class UMjFrameQuatSensor
 * @brief Specific FrameQuat Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjFrameQuatSensor : public UMjSensor
{
    GENERATED_BODY()
public:

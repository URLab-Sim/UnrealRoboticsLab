...
#include "MjFrameXAxisSensor.generated.h"

/**
 * @class UMjFrameXAxisSensor
 * @brief Specific FrameXAxis Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjFrameXAxisSensor : public UMjSensor
{
    GENERATED_BODY()
public:

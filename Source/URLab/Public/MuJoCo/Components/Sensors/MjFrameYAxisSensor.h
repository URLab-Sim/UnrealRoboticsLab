...
#include "MjFrameYAxisSensor.generated.h"

/**
 * @class UMjFrameYAxisSensor
 * @brief Specific FrameYAxis Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjFrameYAxisSensor : public UMjSensor
{
    GENERATED_BODY()
public:

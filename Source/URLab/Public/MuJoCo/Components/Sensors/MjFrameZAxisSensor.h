...
#include "MjFrameZAxisSensor.generated.h"

/**
 * @class UMjFrameZAxisSensor
 * @brief Specific FrameZAxis Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjFrameZAxisSensor : public UMjSensor
{
    GENERATED_BODY()
public:

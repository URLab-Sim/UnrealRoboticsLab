...
#include "MjGeomFromToSensor.generated.h"

/**
 * @class UMjGeomFromToSensor
 * @brief Specific GeomFromTo Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjGeomFromToSensor : public UMjSensor
{
    GENERATED_BODY()
public:

...
#include "MjGeomNormalSensor.generated.h"

/**
 * @class UMjGeomNormalSensor
 * @brief Specific GeomNormal Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjGeomNormalSensor : public UMjSensor
{
    GENERATED_BODY()
public:

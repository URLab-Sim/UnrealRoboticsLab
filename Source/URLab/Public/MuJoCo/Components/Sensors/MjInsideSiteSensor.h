...
#include "MjInsideSiteSensor.generated.h"

/**
 * @class UMjInsideSiteSensor
 * @brief Specific InsideSite Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjInsideSiteSensor : public UMjSensor
{
    GENERATED_BODY()
public:

...
#include "MjJointLimitFrcSensor.generated.h"

/**
 * @class UMjJointLimitFrcSensor
 * @brief Specific JointLimitFrc Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjJointLimitFrcSensor : public UMjSensor
{
    GENERATED_BODY()
public:

...
#include "MjJointLimitPosSensor.generated.h"

/**
 * @class UMjJointLimitPosSensor
 * @brief Specific JointLimitPos Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjJointLimitPosSensor : public UMjSensor
{
    GENERATED_BODY()
public:

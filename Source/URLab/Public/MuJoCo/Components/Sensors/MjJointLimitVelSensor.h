...
#include "MjJointLimitVelSensor.generated.h"

/**
 * @class UMjJointLimitVelSensor
 * @brief Specific JointLimitVel Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjJointLimitVelSensor : public UMjSensor
{
    GENERATED_BODY()
public:

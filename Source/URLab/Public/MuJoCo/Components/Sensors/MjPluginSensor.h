...
#include "MjPluginSensor.generated.h"

/**
 * @class UMjPluginSensor
 * @brief Autogenerated component representing the MuJoCo 'plugin' element.
 *
 * Subclass of UMjSensor. Sets Type = Plugin in the constructor.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjPluginSensor : public UMjSensor
{
	GENERATED_BODY()

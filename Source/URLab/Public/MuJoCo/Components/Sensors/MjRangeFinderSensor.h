...
#include "MjRangeFinderSensor.generated.h"

/**
 * @class UMjRangeFinderSensor
 * @brief Specific RangeFinder Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjRangeFinderSensor : public UMjSensor
{
    GENERATED_BODY()
public:

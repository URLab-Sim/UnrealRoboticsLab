...
#include "MjSubtreeAngMomSensor.generated.h"

/**
 * @class UMjSubtreeAngMomSensor
 * @brief Specific SubtreeAngMom Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjSubtreeAngMomSensor : public UMjSensor
{
    GENERATED_BODY()
public:

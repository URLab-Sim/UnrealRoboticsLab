...
#include "MjSubtreeComSensor.generated.h"

/**
 * @class UMjSubtreeComSensor
 * @brief Specific SubtreeCom Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjSubtreeComSensor : public UMjSensor
{
    GENERATED_BODY()
public:

...
#include "MjSubtreeLinVelSensor.generated.h"

/**
 * @class UMjSubtreeLinVelSensor
 * @brief Specific SubtreeLinVel Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjSubtreeLinVelSensor : public UMjSensor
{
    GENERATED_BODY()
public:

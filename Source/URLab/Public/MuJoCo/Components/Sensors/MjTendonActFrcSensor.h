...
#include "MjTendonActFrcSensor.generated.h"

/**
 * @class UMjTendonActFrcSensor
 * @brief Specific TendonActFrc Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjTendonActFrcSensor : public UMjSensor
{
    GENERATED_BODY()
public:

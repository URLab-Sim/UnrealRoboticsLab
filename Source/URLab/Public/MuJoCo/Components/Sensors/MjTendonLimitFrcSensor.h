...
#include "MjTendonLimitFrcSensor.generated.h"

/**
 * @class UMjTendonLimitFrcSensor
 * @brief Specific TendonLimitFrc Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjTendonLimitFrcSensor : public UMjSensor
{
    GENERATED_BODY()
public:

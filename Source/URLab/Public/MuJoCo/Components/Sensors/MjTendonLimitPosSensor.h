...
#include "MjTendonLimitPosSensor.generated.h"

/**
 * @class UMjTendonLimitPosSensor
 * @brief Specific TendonLimitPos Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjTendonLimitPosSensor : public UMjSensor
{
    GENERATED_BODY()
public:

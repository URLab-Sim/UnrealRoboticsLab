...
#include "MjTendonLimitVelSensor.generated.h"

/**
 * @class UMjTendonLimitVelSensor
 * @brief Specific TendonLimitVel Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjTendonLimitVelSensor : public UMjSensor
{
    GENERATED_BODY()
public:

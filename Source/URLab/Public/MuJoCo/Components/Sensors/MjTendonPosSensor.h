...
#include "MjTendonPosSensor.generated.h"

/**
 * @class UMjTendonPosSensor
 * @brief Specific TendonPos Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjTendonPosSensor : public UMjSensor
{
    GENERATED_BODY()
public:

...
#include "MjTendonVelSensor.generated.h"

/**
 * @class UMjTendonVelSensor
 * @brief Specific TendonVel Sensor component.
 */
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent))
class URLAB_API UMjTendonVelSensor : public UMjSensor
{
    GENERATED_BODY()
public:

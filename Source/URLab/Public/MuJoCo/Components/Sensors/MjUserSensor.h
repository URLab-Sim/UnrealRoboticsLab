...
#include "MjUserSensor.generated.h"

/**
 * @class UMjUserSensor
 * @brief Autogenerated component representing the MuJoCo 'user' element.
 *
 * Subclass of UMjSensor. Sets Type = User in the constructor.
 */
UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class URLAB_API UMjUserSensor : public UMjSensor
{
    GENERATED_BODY()

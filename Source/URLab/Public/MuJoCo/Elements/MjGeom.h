...
public:
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "MuJoCo|Visual")
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "MuJoCo|Mesh")
	FString MeshName;

	/** Collide against the full mesh rather than its convex hull. */
	UPROPERTY(BlueprintReadWrite, Category = "MuJoCo|Mesh")

 ...
 * the held UMjbAssetBaker, whose MJB textures no imported asset set carries.
 */
class URLAB_API FMjBakedAssetResolver : public IMjGeomAssetResolver
{
public:
	FMjBakedAssetResolver(mjModel_* InModel, UMjbAssetBaker* InBaker);

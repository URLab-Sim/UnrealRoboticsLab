...
public:
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "Time constant of the activation dynamics. (MJCF: timeconst)"))
	TOptional<double> Timeconst;

	/** Area of the cylinder. This is used internally as actuator gain. (MJCF: area) */
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "Area of the cylinder. This is used internally as actuator gain. (MJCF: area)"))
	TOptional<double> Area;

	/** Bias parameters, copied internally into biasprm. (MJCF: bias) */
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "Bias parameters, copied internally into biasprm. (MJCF: bias)"))

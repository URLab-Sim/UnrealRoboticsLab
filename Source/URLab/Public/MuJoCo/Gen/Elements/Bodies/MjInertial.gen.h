...
public:
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "Position of the inertial frame. This attribute is required even when the inertial properties can be inferred from geoms. This is because the presence of the inertial element itself disables the automatic inference mechanism. (MJCF: pos)"))
	FMjPosition3 Pos;

	/** Orientation of the inertial frame. See COrientation. (MJCF: quat) */
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "Orientation of the inertial frame. See COrientation. (MJCF: quat)"))
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "Diagonal inertia matrix, expressing the body inertia relative to the inertial frame. If this attribute is omitted, the next attribute becomes required. (MJCF: diaginertia)"))

...
public:
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "Name of the first body participating in the constraint. Either this attribute and must be specified or site1 and site2 must be specified. (MJCF: body1)", GetOptions = "GetBody1Options"))

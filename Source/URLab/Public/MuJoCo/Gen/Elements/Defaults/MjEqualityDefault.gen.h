...
public:
	/** MJCF: active */
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "MJCF: active"))
	TOptional<bool> ActiveFlag;

	/** MJCF: solref */
	UPROPERTY(EditAnywhere, Category = "MuJoCo", AdvancedDisplay, meta = (ToolTip = "MJCF: solref"))
	TOptional<TArray<double>> Solref;

	/** MJCF: solimp */
	UPROPERTY(EditAnywhere, Category = "MuJoCo", AdvancedDisplay, meta = (ToolTip = "MJCF: solimp"))

...
public:
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "Position of the geom, specified in the frame of the body where the geom is defined. (MJCF: pos)"))
	TOptional<FMjPosition3> Pos;

	/** Orientation of the geom frame. See COrientation. (MJCF: quat) */
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "Orientation of the geom frame. See COrientation. (MJCF: quat)"))
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "This attribute must be specified if and only if the geom type is 'hfield'. It references the height field asset to be instantiated at the position and orientation of the geom frame. (MJCF: hfield)", GetOptions = "GetHfieldOptions"))
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", AdvancedDisplay, meta = (ToolTip = "Dimensionless coefficients of fluid interaction model, as follows. See section on ellipsoid-based fluid interaction model for details. (MJCF: fluidcoef)"))

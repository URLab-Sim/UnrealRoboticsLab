...
public:
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "This attribute imposes a lower bound on the diagonal inertia components of each body except for the world body. Its use is similar to boundmass above. (MJCF: boundinertia)"))
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "When this attribute is 'true', the parser will remove any path information in file names specified in the model. This is useful for loading models created on a different system using a different directory structure. (MJCF: strippath)"))
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "This attribute specifies whether frame positions and orientations are expressed in local coordinates. The 'global' option is no longer supported and will cause an error. (MJCF: coordinate)"))
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "This attribute is used to instruct the compiler where to look for texture files. It works in the same way as meshdir above. (MJCF: texturedir)"))
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "If this attribute is 'true', the model compiler will run in multi-threaded mode. Multi-threading is used for computing the length ranges of actuators and for parallel loading and processing of meshes. (MJCF: usethread)"))
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "If set to 'true', the compiler will save explicit inertial clauses for all bodies. (MJCF: saveinertial)"))
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "This attribute sets the values of both meshdir and texturedir above. Values in the latter attributes take precedence over assetdir. (MJCF: assetdir)"))

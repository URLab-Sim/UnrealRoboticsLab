...
public:
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "If this attribute is 'true' and the actuator is attached to a joint or a tendon which has limits defined, these limits will be copied into the actuator length range and the automatic computation will be skipped. (MJCF: uselimit)"))
	...
	UPROPERTY(EditAnywhere, Category = "MuJoCo", meta = (ToolTip = "The total time interval (in seconds) for running the internal simulation, for each actuator and actuator direction. Each simulation is initialized at qpos0. It is expected to settle after inttotal time has passed. (MJCF: inttotal)"))

...
public:
	...
	/** MJCF: delay */
	UPROPERTY(EditAnywhere, Category = "MuJoCo|Rangefinder|SensorBase", meta = (ToolTip = "MJCF: delay"))
	TOptional<double> Delay;

	/** MJCF: interval */
	UPROPERTY(EditAnywhere, Category = "MuJoCo|Rangefinder|SensorBase", meta = (ToolTip = "MJCF: interval"))
	TOptional<TArray<double>> Interval;

	/** MJCF: cutoff */
	UPROPERTY(EditAnywhere, Category = "MuJoCo|Rangefinder|SensorBase", meta = (ToolTip = "MJCF: cutoff"))
	TOptional<double> Cutoff;

	/** MJCF: noise */
	UPROPERTY(EditAnywhere, Category = "MuJoCo|Rangefinder|SensorBase", meta = (ToolTip = "MJCF: noise"))

...
struct GeomView
{
	...
	GeomView()
		: _m(nullptr), _d(nullptr), id(-1) {}

	GeomView(const mjModel* m, mjData* d, int id_in)
		: _m(m), _d(d), id(id_in)
	{
...
struct JointView
{
	...
	JointView(const mjModel* m, mjData* d, int id_in)
		: _m(m), _d(d), id(id_in)
	{
...
struct ActuatorView
{
	...
	ActuatorView(const mjModel* m, mjData* d, int id_in)
		: _m(m), _d(d), id(id_in)
	{
		check(id >= 0 && id < m->nu);
...
struct TendonView
{
	...
	TendonView()
		: _m(nullptr), _d(nullptr), id(-1), name(nullptr) {}

	TendonView(const mjModel* m, mjData* d, int id_in)
		: _m(m), _d(d), id(id_in)
	{
...
struct SensorView
{
	...
	SensorView(const mjModel* m, mjData* d, int id_in)
		: _m(m), _d(d), id(id_in)
	{
...
struct SiteView
{
	...
	SiteView(const mjModel* m, mjData* d, int id_in)
		: _m(m), _d(d), id(id_in)
	{
...
struct BodyView
{
	...
	BodyView(const mjModel* m, mjData* d, int id_in)
		: _m(m), _d(d), id(id_in)
	{

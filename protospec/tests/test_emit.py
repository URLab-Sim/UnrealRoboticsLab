...
from protospec_gen import emit, load_schema
...
def test_geom_struct_contains_expected_fields():
    ...
    # Presence-tracked scalar, enum, ref, arity, and child-list shapes.
    ...
    assert "ps::opt<std::array<double, 6>> fromto" in body  # fixed arity
...
def test_xml_binding_routes_input_aliases_and_worldbody():
    binding_cc = _generated()["xml_binding.cc"]
    # Orientation canonicalization: euler/axisangle/... are read-only input
    # aliases of the canonical quat, routed via the orientation resolver.
